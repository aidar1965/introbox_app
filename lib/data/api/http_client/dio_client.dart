...
// enum _Methods { get, post, put, delete, patch }
...
//   Future<void> otpRequest({required bodyMap}) async {
//     await _request(
//         method: _Methods.post,
...
//     await _request(method: _Methods.post, url: _coursesRoute, body: bodyMap);
//   }
...
//   Future<Response<Object?>?> getPublishedCourses() async {
//     List<Course>? courses = [];
//     Response<Object?>? response = await _request(
//       method: _Methods.get,
//       url: _coursesRoute,
...
//         json.decode(response?.data as String) as Map<String, Object?>;
//     List courseData = json.decode(data['courses'] as String);

//     var c = mapper!.mapCourse(courseData[0] as CourseDto);
//     dev.log(courseData.length.toString());
