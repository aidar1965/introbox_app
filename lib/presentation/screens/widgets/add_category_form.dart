...
Future<bool?> _showAlertDialog(BuildContext context, RecordCategory category) async {
        ...
        content: SingleChildScrollView(
          child: ListBody(
            children: const <Widget>[
              Text('При удалении категории записи, относящиеся к этой категории не удаляются.'),
              Text('Продолжить?'),
            ],
          ),
        ),
