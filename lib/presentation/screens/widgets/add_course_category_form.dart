...
class AddCourseCategoryForm extends StatelessWidget {
  const AddCourseCategoryForm({Key? key, this.category}) : super(key: key);
  ...
  Future<bool?> _showAlertDialog(
      BuildContext context, CourseCategory category) async {
