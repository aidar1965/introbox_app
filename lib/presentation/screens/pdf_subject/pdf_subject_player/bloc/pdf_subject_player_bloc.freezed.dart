...
/// @nodoc
abstract class $PdfSubjectPlayerEventCopyWith<$Res> {
  factory $PdfSubjectPlayerEventCopyWith(PdfSubjectPlayerEvent value,
          $Res Function(PdfSubjectPlayerEvent) then) =
      _$PdfSubjectPlayerEventCopyWithImpl<$Res, PdfSubjectPlayerEvent>;
}

/// @nodoc
class _$PdfSubjectPlayerEventCopyWithImpl<$Res,
        $Val extends PdfSubjectPlayerEvent>
    implements $PdfSubjectPlayerEventCopyWith<$Res> {
  _$PdfSubjectPlayerEventCopyWithImpl(this._value, this._then);
...
class __$$_EventDataRequestedCopyWithImpl<$Res>
    extends _$PdfSubjectPlayerEventCopyWithImpl<$Res, _$_EventDataRequested>
...
class _$_EventDataRequested implements _EventDataRequested {
  ...
  @override
  String toString() {
    return 'PdfSubjectPlayerEvent.dataRequested()';
  }
...
abstract class _EventDataRequested implements PdfSubjectPlayerEvent {
  const factory _EventDataRequested() = _$_EventDataRequested;
}

/// @nodoc
mixin _$PdfSubjectPlayerState {
  @optionalTypeArgs
  TResult when<TResult extends Object?>({
...
/// @nodoc
abstract class $PdfSubjectPlayerStateCopyWith<$Res> {
  factory $PdfSubjectPlayerStateCopyWith(PdfSubjectPlayerState value,
          $Res Function(PdfSubjectPlayerState) then) =
      _$PdfSubjectPlayerStateCopyWithImpl<$Res, PdfSubjectPlayerState>;
}

/// @nodoc
class _$PdfSubjectPlayerStateCopyWithImpl<$Res,
        $Val extends PdfSubjectPlayerState>
    implements $PdfSubjectPlayerStateCopyWith<$Res> {
  _$PdfSubjectPlayerStateCopyWithImpl(this._value, this._then);
...
class __$$_StatePendingCopyWithImpl<$Res>
    extends _$PdfSubjectPlayerStateCopyWithImpl<$Res, _$_StatePending>
...
class _$_StatePending implements _StatePending {
  ...
  @override
  String toString() {
    return 'PdfSubjectPlayerState.pending()';
  }
...
abstract class _StatePending implements PdfSubjectPlayerState {
...
class __$$_ScreenStateCopyWithImpl<$Res>
    extends _$PdfSubjectPlayerStateCopyWithImpl<$Res, _$_ScreenState>
...
class _$_ScreenState implements _ScreenState {
  ...
  @override
  String toString() {
    return 'PdfSubjectPlayerState.screenState(fragments: $fragments)';
  }
...
abstract class _ScreenState implements PdfSubjectPlayerState {
...
class __$$_StateLoadingErrorCopyWithImpl<$Res>
    extends _$PdfSubjectPlayerStateCopyWithImpl<$Res, _$_StateLoadingError>
...
class _$_StateLoadingError implements _StateLoadingError {
  ...
  @override
  String toString() {
    return 'PdfSubjectPlayerState.loadingError(errorText: $errorText)';
  }
...
abstract class _StateLoadingError implements PdfSubjectPlayerState {
