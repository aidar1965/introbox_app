...
import 'package:moki_tutor/domain/repositories/records_repository.dart';
...
class Environment {
  static Map<Type, Object> buildEnvironment(ILocalDB db) {
    ...
    final IRecordsRepository recordsRepository =
        RecordsRepository(db: db, categoryRepository: categoryRepository);
    ...
    environment[IRecordsRepository] = recordsRepository;
