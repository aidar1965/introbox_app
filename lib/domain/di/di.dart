...
//   FragmentsBloc? _recordsBloc;
//   SubjectsBloc? _subjectsBloc;

//   EditFragmentBloc? _editFragmentBloc;
...
//           recordsRepository: g<IFragmentsRepository>(),
//           categoryRepository: g<ICategoryRepository>());
//     }
//     return _recordingBloc!;
//   }

//   FragmentsBloc buildFragmentsBloc({bool forceCreate = true}) {
//     if (_recordsBloc == null || forceCreate) {
//       _recordsBloc = FragmentsBloc(
//           requestManager: g<IRequestManager>(),
//           recordsRepository: g<IFragmentsRepository>(),
//           categoryRepository: g<ICategoryRepository>());
//     }
...
//   EditFragmentBloc buildEditFragmentrBloc(Fragment record,
//       {bool forceCreate = true}) {
//     if (_editFragmentBloc == null || forceCreate) {
//       _editFragmentBloc = EditFragmentBloc(
//           record: record,
//           recordsRepository: g<IFragmentsRepository>(),
//           categoryRepository: g<ICategoryRepository>());
//     }
//     return _editFragmentBloc!;
//   }
